...
addEquipmentForm.addEventListener("submit", function (e) {
    ...
    let inputNumOfType = document.getElementById("input-numOfType");
    let inputReplacementCost = document.getElementById("input-replacementCost");
...
addRowToTable = (data) => {
    ...
    let currentTable = document.getElementById("equipments-table");
    ...
    let numOfTypeCell = document.createElement("TD");
    let replacementCostCell = document.createElement("TD");
    ...
    numOfTypeCell.innerText = newRow.numOfType;
    replacementCostCell.innerText = newRow.replacementCost;
